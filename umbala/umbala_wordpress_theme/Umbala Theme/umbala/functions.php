...
function umbala_enqueue_scripts() {
    ...
    wp_enqueue_script('pjax', get_template_directory_uri() . '/assets/js/jquery.pjax.js', array(), null, true);
    ...
    $translations = array(
        ...
        'alus_ajax_search_nonce' => wp_create_nonce( 'umbala-ajax-search' ),
        ...
        'alus_cookie_notice' => (int) umbala_get_opt('alus_cookie_notice'),
        'alus_cookie_expiry' => (int) umbala_get_opt('alus_cookie_expiry'),
        'alus_grid_list' => (umbala_get_opt('alus_grid_list_default')) ? umbala_get_opt('alus_grid_list_default') : 'grid',
    );
