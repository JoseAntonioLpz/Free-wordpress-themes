        ...
        if ( function_exists('icl_get_languages') ) {
            ...
            if (!empty($languages)) {
                ...
                foreach ($languages as $lang) {
                    ...
                    if ($lang['active']) {
                        $active_lang .= umbala_icl_language($lang['native_name'], $lang['translated_name']);
                    } else {
                        $other_langs .= umbala_icl_language($lang['native_name'], $lang['translated_name']);
                    }
                    if (!$lang['active']) {
                        $other_langs .= '</a></li>';
                    }
                ...
                <div id="lang_sel_click" class="lang_sel_click">
                    <ul>
                        <li>
                            <a href="#" class="lang_sel_sel icl-en"><?php echo ($active_lang); ?></a>
                            <?php if ($other_langs) : ?>
...
function umbala_icl_language( $native_name, $translated_name = false, $lang_native_hidden = false, $lang_translated_hidden = false ) {
