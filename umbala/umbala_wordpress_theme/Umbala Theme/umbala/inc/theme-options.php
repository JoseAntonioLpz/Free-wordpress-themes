...
if (!class_exists('Umbala_Redux_Framework_Option')) {
    class Umbala_Redux_Framework_Option {
        ...
        function setSections() {
            ...
            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('Custom 404 Page', 'umbala'),
                'fields' => array(
                    array(
                        'id' => 'alus_enable_custom_404_page',
                        'type' => 'switch',
                        'title' => esc_html__('Enable Custom 404 Page', 'umbala'),
                        'default' => 0,
                    ),
                    array(
                        'id' => 'alus_custom_404_page',
                        'type' => 'select',
                        'title' => esc_html__('Custom 404 Page', 'umbala'),
                        'data' => 'pages',
                        'required' => array(
                            array('alus_enable_custom_404_page', 'equals', 1),
                        ),
                    ),
                ),
            );
...
/** Header Options **/
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'alus_enable_search_sticky',
                        'type' => 'switch',
                        'title' => esc_html__('Search on sticky header', 'umbala'),
                        'default' => 0,
                    ),
                    array(
...
/*** WooCommerce Config     ** */
            if (class_exists('Woocommerce')) {
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            'title' => esc_html__("Ajax Shop", "umbala"),
                            'desc' => '',
                            'id' => "alus_ajax_shop",
                            'default' => 0,
                            'type' => "switch",
...
/** Maintenance **/
            $this->sections[] = array(
                'icon' => 'el el-off',
                'icon_class' => 'icon',
                'title' => esc_html__('Maintenance', 'umbala'),
                'fields' => array(
                    array(
                        'id' => 'alus_maintenance_mode',
                        'type' => 'switch',
                        'title' => esc_html__('Enable maintenance mode', 'umbala'),
                        'default' => 0,
                    ),
                    array(
                        'id' => 'alus_maintenance_mode_page',
                        'type' => 'select',
                        'title' => esc_html__('Maintenance mode page', 'umbala'),
                        'desc' => esc_html__('Select page to maintenance mode. For example: "Coming soon" or You can create page: Page > Add new and choose Template "Blank Page Template" in Page Attributes', 'umbala'),
                        'data' => 'pages',
                    ),
                ),
            );
            ...
            $this->sections[] = array(
                'icon' => 'el el-link',
                'icon_class' => 'icon',
                'title' => esc_html__('Social Button', 'umbala'),
                'fields' => array(
                    array(
                        'id'    => 'alus_social_button',
                        'type'  => 'switch',
                        'title' => esc_html__('Enable Social Button', 'umbala'),
                        'default'   => 0,
                    ),
                    array(
                        'id'    => 'alus_social_button_mobile',
                        'type'  => 'switch',
                        'title' => esc_html__('Disable Social Button on Mobile', 'umbala'),
                        'default'   => 1,
                    ),
                    array(
                        'id' => 'alus_social_position', 
                        'type'  => 'select',
                        'title' => esc_html__('Social position', 'umbala'),
                        'options'   => array(
                            'left'  => esc_html__('Left', 'umbala'),
                            'right' => esc_html__('Right', 'umbala'),
                        ),
                        'default'   => 'right'
                    ),
                    array( 
                        'id'       => 'alus_social_type',
                        'type'     => 'select',
                        'title'    => esc_html__( 'Social type', 'umbala' ),
                        'options'  => array(
                            'share' => esc_html__( 'Share', 'umbala' ), 
                            'follow' => esc_html__( 'Follow', 'umbala' ),
                        ),
                        'default' => 'follow',
                    ),
                    array(
                        'id'    => 'facebook_link',
                        'type'  => 'text',
                        'title' => esc_html__('Facebook link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ),
                    array(
                        'id'    => 'twitter_link',
                        'type'  => 'text',
                        'title' => esc_html__('Twitter link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ...
                    array(
                        'id'    => 'instagram_link',
                        'type'  => 'text',
                        'title' => esc_html__('Instagram link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ...
                    array(
                        'id'    => 'google_link',
                        'type'  => 'text',
                        'title' => esc_html__('Google link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ...
                    array(
                        'id'    => 'youtube_link',
                        'type'  => 'text',
                        'title' => esc_html__('Youtube link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ...
                    array(
                        'id'    => 'pinterest_link',
                        'type'  => 'text',
                        'title' => esc_html__('Pinterest link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ...
                    array(
                        'id'    => 'linkedin_link',
                        'type'  => 'text',
                        'title' => esc_html__('LinkedIn link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
                    ...
                    array(
                        'id'    => 'reddit_link',
                        'type'  => 'text',
                        'title' => esc_html__('Reddit link', 'umbala'),
                        'default'   => '#',
                        'required' => array(
                            array( 'alus_social_type', 'equals', 'follow' ),
                        ),
            ...
            $this->sections[] = array(
                'icon' => 'el el-bullhorn',
                'icon_class' => 'icon',
                'title' => esc_html__('Cookie Notice', 'umbala'),
                'fields' => array(
                    array(
                        'id'    => 'alus_cookie_notice',
                        'type'  => 'switch',
                        'title' => esc_html__('Enable Cookie Notice', 'umbala'),
                        'default'   => 0,
                    ),
                    array(
                        'id'    => 'alus_cookie_text',
                        'type'  => 'textarea',
                        'title' => esc_html__('Message', 'umbala'),
                        'subtitle' => esc_html__('Enter the cookie notice message', 'umbala'),
                        'default'   => esc_html__('We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.', 'umbala'),
                    ),
                    array(
                        'id'    => 'alus_cookie_info_link',
                        'type'  => 'select',
                        'title' => esc_html__('More info link', 'umbala'),
                        'subtitle'  => esc_html__('Select page to information about cookies', 'umbala'),
                        'data'  => 'pages'
                    ),
                    array(
                        'id'    => 'alus_cookie_expiry',
                        'type'  => 'text',
                        'title' => esc_html__('Cookie Expiry', 'umbala'),
                        'subtitle'  => esc_html__('The ammount of time that cookies should be store for (day).', 'umbala'),
                        'default'   => '30'
                    ),
                ),
            );
