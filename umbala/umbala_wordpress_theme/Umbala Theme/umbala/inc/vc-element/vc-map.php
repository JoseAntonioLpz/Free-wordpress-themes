...
vc_map( array(
	...
	'params' 	=> array(
		...
		,array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Content Position', 'umbala' ),
			'param_name' => 'content_position',
			'value' => array(
				esc_html__('Top Left', 'umbala') => 'top_left',
				esc_html__('Top Center', 'umbala') => 'top_center',
				esc_html__('Top Right', 'umbala') => 'top_left',
				esc_html__('Center Left', 'umbala') => 'center_left',
				esc_html__('Center', 'umbala') => 'center',
				esc_html__('Center Right', 'umbala') => 'center_right',
				esc_html__('Bottom Left', 'umbala') => 'bottom_left',
				esc_html__('Bottom Center', 'umbala') => 'bottom_center',
				esc_html__('Bottom Right', 'umbala') => 'bottom_right',
			),
			'dependency' 	=> array('element' => 'show_content', 'value' => array( '1' ))
		)
	)
