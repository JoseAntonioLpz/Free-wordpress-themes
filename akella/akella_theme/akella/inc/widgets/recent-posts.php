...
class Akella_Recent_Posts_Widget extends WP_Widget {
	/**
	 * Constructor.
	 *
	 * @return Akella_Recent_Posts_Widget
	 */
	public function __construct() {
		parent::__construct( 'widget_akella_recent_posts', esc_html__( 'Akella Recent Posts', 'akella' ), array(
			'classname'   => 'widget_akella_recent_posts',
			'description' => esc_html__( 'Use this widget to list your recent posts. Well-suited to display in the sidebar.', 'akella' ),
	...
	public function widget( $args, $instance ) {
		...
		$title  = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Recent Posts', 'akella' ) : $instance['title'], $instance, $this->id_base );
