<?php
/**
 * Most Commented Theme Widget (Type 1).
 *
...
class Akella_Most_Commented_One_Widget extends WP_Widget {
	/**
	 * Constructor.
	 *
	...
	public function __construct() {
		parent::__construct( 'widget_akella_most_commented_posts_one', esc_html__( 'Akella Most Commented 1', 'akella' ), array(
